...
cl /nologo /Zi /MD /utf-8 /EHsc /D_WIN32_WINNT=0x0601 /DGL_SILENCE_DEPRECATION %INCLUDES% @build_sources.txt /Fo%OUT_DIR%/ /link /MACHINE:X64 %LIBS% /OUT:%OUT_DIR%\%OUT_EXE%.exe
